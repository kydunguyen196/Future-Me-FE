...
import { Globe, XCircle, ArrowLeft, Lock, Eye, EyeOff } from 'lucide-react';
            ...
            <CardContent>
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="relative">
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          className="absolute right-0 top-1/2 -translate-y-1/2 h-full w-9 px-0"
              ...
              {!resetPasswordLoading && (
                <div className="text-center text-sm mt-6">
                  <Link 
                    to="/auth/login" 
                    className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline underline-offset-4"
